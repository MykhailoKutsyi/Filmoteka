import { STORAGE_KEY_WATCHED, STORAGE_KEY_QUEUE, IMG_URL } from '../utils/constants';
import { refsLibrary, libraryNavEl } from './header';
...
function emptyWatchedLibNtf(e) {
  e.preventDefault();
  if (
    refsLibrary.watchedBtn.classList.contains('library-btn-current') &&
...
function emptyQueueLibNtf(e) {
  e.preventDefault();
  if (
    refsLibrary.queueBtn.classList.contains('library-btn-current') &&
